...
* Futures contract typically has a specific expiration date. Traders who do not want to take delivery need to close their positions before the expiration date.
  * Typically, futures FCM might remind their clients to close their positions before the First Notice Day, which is the first day when the exchange notifys the delivery matching. 
...
* However, even though it sounds like as simple as two trades in the market, there is still something to ask
  * When rollover typically happens? Can data tell us a little? 
  * How to rollover? Just dierctly initate two (outright) trades in the two contract months? Or is there any better way to do so? 
...
* Calendar spread contracts are traded in the futures markets and they represent the price difference between two contract months. For example, in the corn futures, the calendar spread contract is directly quoted as the price spread between two legs, such as -0.25 cents/bushel for the spread between December 2024 and March 2025 contracts.
  ...
  * A big advantage of trading calendar spreads is the price spread between two legs is guaranteed.
...
* A huge decline in trading volume is observed after 14 days before the expiration date. Such magnitude is substaintial, especially for calendar spreads. The daily median volume of calendar spreads is about 30K contracts, while it is only about 1K contracts after 14 days.  
* Outright market witnesses a more smoother decline in trading volume than calendar spread market.
* Sell trading volume is slightly higher than buy traidng volume during the whole period.

* I highlight two preiods where typical huge calendar spread volume can be observed:
